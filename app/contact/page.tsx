            ...
            >
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-12 h-12 rounded-full bg-signature-gold/20 flex items-center justify-center text-signature-gold hover:bg-signature-gold hover:text-charcoal-black transition-all">
